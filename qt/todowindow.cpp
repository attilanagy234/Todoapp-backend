...
//     m_pActAdd->setIcon(QIcon(":/images/add.png"));
//     connect(m_pActAdd, &QAction::triggered, this, &TodoWindow::onAdd);

//     m_pActRemove = new QAction(this);
//     m_pActRemove->setIcon(QIcon(":/images/remove.png"));
//     connect(m_pActRemove, &QAction::triggered, this, &TodoWindow::onRemove);
...
{
//    m_pwPending->model()->insertColumns(m_pwPending->model()->rowCount(), 3);
